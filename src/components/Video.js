...
import PopupExamplePopperDependencies from './PopupExamplePopperDependencies.js';
  ...
  render() {
    ...
    //       config={{ file: {
        ...
        {Object.keys(subtitles).map((i, index) => (
          ...
          <Popup
            trigger={<Icon style={{paddingRight:'50px',color:'#d4d4d4'}} link name='comment alternate outline' />}
            on='click'
